...
public class MaterialsManager {
   ...
   @Transactional
    public void addMaterialBasedOnMaterial(MaterialInfoDto childDto, MaterialDto parentDto) {
...
//
//        List<MaterialThickness> thicknesses = material.getMaterialThicknessList();
//        thicknessRepository.deleteAll(thicknesses);
